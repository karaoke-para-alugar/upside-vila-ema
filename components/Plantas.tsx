  ...
  const plantas = [
    {
      ...
      image: '/assets/images/UpSide_View_Vila_Ema_Planta_2_Dormitorios_47m-scaled-1-1.webp',
      features: ['Varanda Gourmet', 'Suíte Master', 'Opção de Escritório'],
    },
    {
      title: '48M²',
      dormitorios: '2 DORMITÓRIOS',
      image: '/assets/images/UpSide_View_Vila_Ema_Planta_2_Dormitorios_48m-scaled-1-1.webp',
      features: ['Terraço Social', 'Ventilação Natural', 'Área de Serviço'],
    },
    {
      title: '80,5M²',
      dormitorios: '2 DORM. (1 SUÍTE)',
      image: '/assets/images/Up_Side_Vila_Ema_Planta_2_Dormitorios_805m-scaled-1-1.webp',
      features: ['Living Ampliado', 'Suíte Master', 'Cozinha Aberta'],
    },
    {
      title: '80,5M²',
      dormitorios: '3 DORM. (1 SUÍTE)',
      image: '/assets/images/UpSide_Vila_Ema_Planta_3_Dormitorios_805m-scaled-1-1.webp',
      features: ['Varanda Gourmet', 'Suíte com Closet', 'Banheiro Social'],
    },
    {
      title: '92M²',
      dormitorios: '3 DORM. (1 SUÍTE)',
      image: '/assets/images/UpSide_Vila_Ema_Planta_3_Dormitorios_92m-scaled-1-1.webp',
